...
#include "arduinoCommunication/srv/leaf_command.hpp"
...
public:
    leafServer() : Node("leafServerNode"), vacuum_on(false), spray_on(false)
    {
        ...
        command_service_ = this->create_service<arduinoCommunication::srv::LeafCommand>(
            "send_command",
...
private:
    rclcpp::Service<arduinoCommunication::srv::LeafCommand>::SharedPtr command_service_;
    ...
    void handle_command(
        const std::shared_ptr<arduinoCommunication::srv::LeafCommand::Request> request,
        std::shared_ptr<arduinoCommunication::srv::LeafCommand::Response> response)
    {
